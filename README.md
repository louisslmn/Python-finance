# Portfolio Python – Finance

Ce dépôt présente une sélection de projets réalisés en Python et appliqués à la finance.

Ces projets visent à montrer ma capacité à mobiliser Python pour analyser des données financières, modéliser le risque et la performance, et mettre en œuvre des outils utilisés en finance moderne.

---

## 📂 Projets

### 🔹 Tableau de bord de portefeuille & optimisation simple
Analyse d’un portefeuille d’actifs financiers à partir de données historiques.  
...
### 🔹 Analyse financière d’entreprise & scoring (extra-financier)
...
Chaque dépôt de projet contient un README détaillé présentant :
- la problématique financière étudiée  
- la méthodologie employée  
- les sources de données  
- les principaux résultats et leur interprétation
